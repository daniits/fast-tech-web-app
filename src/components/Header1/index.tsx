  ...
  return (
    <>
      <header className={props.className}>
        <Img
          className="h-[61px] sm:h-auto mb-8 md:ml-[0] ml-[126px] md:mt-0 mt-[19px] object-cover w-[3%] md:w-full"
          src="images/img_logoremovebgpreview.png"
          alt="logoremovebgpre"
        />
            ...
            <div className="flex pb-0.5 pr-0.5 relative w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start w-[71%]">
                <div className="flex flex-col items-center justify-end p-[9px]">
                  <Text
                    className="mt-1.5 text-green-A700 text-sm"
